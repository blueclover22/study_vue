  ...
  <div>
    <table border="1">
      <tbody>
        ...
        <tr v-if="!codeDetails || (Array.isArray(codeDetails) && codeDetails.length === 0)">
          <td colspan="5" align="center">데이터가 없습니다.</td>
        </tr>
        <tr
          v-else
          v-for="codeDetail in codeDetails"
          :key="`${codeDetail.groupCode}-${codeDetail.codeValue}`"
        >
          ...
          <td align="left">
            <router-link
              ...
              >{{ codeDetail.codeName }}</router-link
            >
          </td>
